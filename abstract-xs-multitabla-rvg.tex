...
\begin{figure}[!h]
 \begin{center}
  \subfloat[\label{fig:flux-1}]{\includegraphics[width=0.35\linewidth]{imagenes/HexFlux_g1.pdf}} 
  \subfloat[\label{fig:flux-69}]{ \includegraphics[width=0.35\linewidth]{imagenes/HexFlux_g69.pdf}}\\
...
\noindent
En este caso, una forma de estimar la derivada $\partial\Sigma_x / \partial P_g \left( Q, P^0_g, P^0_l \right)$ es a partir de numerosos cálculos con sus quemados de referencia y \emph{linear loops}. Estos resultados permiten estimar tanto la derivada parcial en función del quemado con dirección al parámetro global como aquella con dirección al parámetro local. Las figuras~\ref{fig:global-local-pth-1}--\ref{fig:global-local-pth-3} resumen gráficamente los conceptos previamente descriptos.
...
\begin{figure}[ht!]
   \centering
   %%----primera subfigura----
   \subfloat[\label{fig:xs-vs-q-0}]{
        \includegraphics[width=0.5\linewidth]{graficos/rho-vs-q-simple/xs-vs-q-0.pdf}}
%    \hspace{0.005\linewidth}
   %%----segunda subfigura----
    \subfloat[\label{fig:xs-vs-q-4000}]{       
        \includegraphics[width=0.5\linewidth]{graficos/rho-vs-q-simple/xs-vs-q-4000.pdf}}\\[10pt]
   %%----tercera subfigura----
    \subfloat[\label{fig:xs-vs-q-8000}]{       
        \includegraphics[width=0.5\linewidth]{graficos/rho-vs-q-simple/xs-vs-q-8000.pdf}}
   %%----tercera subfigura----
    \subfloat[\label{fig:xs-vs-q-11000}]{       
        \includegraphics[width=0.5\linewidth]{graficos/rho-vs-q-simple/xs-vs-q-11000.pdf}}
...
\begin{algorithm}[H]
 ...
 \For{cada potencia lineal}{
   calcular perfiles de temperatura del combustible\;
   condensar perfiles a volúmenes de DRAGON\;
 }
 reemplazar perturbaciones en el \emph{template} del \emph{input}\;
 ejecutar DRAGON\;
 \For{cada valor de trefr para derivada}{
   calcular perfiles de temperatura del combustible\;
   condensar perfiles a volúmenes de DRAGON\;
 }
 reemplazar perturbaciones en el \emph{template} del \emph{input} que corresponda\;
 ejecutar DRAGON\;
 \For{cada parámetro termohidráulico + xenón + propiedades xenón y iodo - trefr}{  
    definir perturbaciones locales dependiendo cual sea el parámetro\;
    reemplazar perturbaciones en el \emph{template} del \emph{input} que corresponda\;
    ejecutar DRAGON\
 }  
